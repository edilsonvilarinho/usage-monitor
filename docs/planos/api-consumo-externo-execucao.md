...
| 2026-08-25 | `server/src/repositories/teamRepository.ts` tem fim de linha **misto** (LF e CRLF na mesma região) | Edição por script casa `?
` em vez de converter o texto inteiro; conversão em bloco produziria diff do arquivo todo |
